package edu.aku.hassannaqvi.ctsam.ui.sync;
...
import edu.aku.hassannaqvi.ctsam.get.GetAllData;
import edu.aku.hassannaqvi.ctsam.otherClasses.SyncModel;
import edu.aku.hassannaqvi.ctsam.sync.SyncAllData;
import edu.aku.hassannaqvi.ctsam.sync.SyncDevice;
