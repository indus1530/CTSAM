...
import edu.aku.hassannaqvi.ctsam.databinding.ActivitySectionD9Binding;
...
public class SectionD9Activity extends AppCompatActivity {
    ...
    private boolean UpdateDB() {
        ...
        int updcount = db.updatesFoodFreqColumn(FoodFreqContract.SingleFoodFreq.COLUMN_SD9, MainApp.foodFreq.getsD9());
        if (updcount == 1) {
            return true;
        } else {
    ...
    private void SaveDraft() throws JSONException {
        ...
        MainApp.foodFreq.setsD9(String.valueOf(json));
