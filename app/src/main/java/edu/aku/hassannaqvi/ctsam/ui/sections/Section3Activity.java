...
//        json.put("fus3q3_title1",bi.fus3q3_title1.isChecked() ? "0" :"-1");
...
//        json.put("fus2q3_title2",bi.fus2q3_title2.isChecked() ? "00" :"-1");
        ...
        json.put("fus3q4dx", bi.fus3q4dx.getText().toString());
        json.put("fus3q5", bi.fus3q5a.isChecked() ? "1"
                : bi.fus3q5b.isChecked() ? "2"
                : "-1");

        json.put("fus3q6", bi.fus3q6.getText().toString());
