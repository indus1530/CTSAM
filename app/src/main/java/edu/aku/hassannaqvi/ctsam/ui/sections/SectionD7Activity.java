...
import edu.aku.hassannaqvi.ctsam.databinding.ActivitySectionD7Binding;
...
public class SectionD7Activity extends AppCompatActivity {
    ...
    private boolean UpdateDB() {
        ...
        int updcount = db.updatesFoodFreqColumn(FoodFreqContract.SingleFoodFreq.COLUMN_SD7, MainApp.foodFreq.getsD7());
        if (updcount == 1) {
            return true;
        } else {
    ...
    private void SaveDraft() throws JSONException {
        ...
        MainApp.foodFreq.setsD7(String.valueOf(json));
